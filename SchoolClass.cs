...
Person student1 = new Person(); // Create the first student, set their properties and print them to the screen
student1.Name = "Ahmet";
...
Person student2 = new Person(); // Create the second student, set their properties and print them to the screen
student2.Name = "Selim";
...
Person teacher1 = new Person(); // Create the first teacher, set their properties and print them to the screen
...
Person teacher2 = new Person(); // Create the second teacher, set their properties and print them to the screen
teacher2.Name = "Osman";
